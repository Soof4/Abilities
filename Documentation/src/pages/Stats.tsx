  ...
  return (
    <>
      ...
      <p className="statsDescription">
        Pumps adrenaline into your blood. Increases movement speed and damage of
        the player.
      </p>
      ...
      <p className="statsDescription">
        Throws different kinds of potions around the player that lasts for a few
        seconds in their location:
        <br />
        1: Heal Potion
        <br />
        2: Harm Potion
      ...
      <table className="statTable">
        ...
        <tbody className="statsBody">
          <tr className="statsRow">
            ...
            <td className="statsCell">Heal, Damage, Vortex, Curse, Shield</td>
      ...
      <p className="statsDescription">
        Summons a healing circle around the player. The circle heals everyone
        inside it and gives them Dryad's Blessing buff.
      </p>
      <table className="statTable">
        <thead className="statsHead">
          <th className="statsHeadCell">Propeties</th>
      ...
      <p className="statsDescription">
        ...
        player.
        <br />
        2: Dash -&gt; Dashes towards the direction player is looking at, and
        creates projectiles behind the player which can damage enemies.
        <br />
        3: Prismatic Bolts -&gt; Periodically spawns prismatic bolts around the
        player that target the nearby enemies.
        <br />
        4: Sundance -&gt; Webs the player in the location and spawns projectiles
        that resemble Empress of Light's sundance attack.
      </p>
      <table className="statTable">
        <thead className="statsHead">
          <th className="statsHeadCell">Propeties</th>
      ...
      <p className="statsDescription">
        Opens a teleportation portal to a random location for everyone around
        the caster.
      </p>
      <table className="statTable">
        <thead className="statsHead">
      ...
      <p className="statsDescription">
        Summons a circle around the player that chooses the enemy with highest
        hp and steals some health from it.
      </p>
      <table className="statTable">
        <thead className="statsHead">
          <th className="statsHeadCell">Propeties</th>
      ...
      <p className="statsDescription">
        Turns you into sand which gives you immunity-frames for some amount of
        time.
      </p>
      <table className="statTable">
        <thead className="statsHead">
      ...
      <p className="statsDescription">
        Bound with the nearest player and get healed every second as long as the
        bound is not broken.
      </p>
      <table className="statTable">
        <thead className="statsHead">
      ...
      <p className="statsDescription">
        ...
        <br />
        1: Brilliant Eyes -&gt; Get vision buffs and spawn projectiles around
        the player that target the nearby enemies.
        <br />
        2: Judgement -&gt; Dazes the player for a bit and attacks enemies within
        a range. If an enemy dies after the attack, they'll spawn a projectile
        which will attack other enemies.
        <br />
        3: Punishment -&gt; Creates an explosion near the player that damages
        enemies nearby and buffs the player for a few seconds.
      </p>
      <table className="statTable">
        <thead className="statsHead">
          <th className="statsHeadCell">Propeties</th>
